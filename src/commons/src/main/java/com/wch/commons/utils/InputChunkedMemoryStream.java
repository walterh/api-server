...
public class InputChunkedMemoryStream extends InputStream {
    private ChunkedMemoryStream bms;

    public InputChunkedMemoryStream(ChunkedMemoryStream bms) throws Exception {
        this(bms, false);
    }

    public InputChunkedMemoryStream(ChunkedMemoryStream cms, boolean disableDispose) throws Exception {
        bms = cms;
        bms.setDisableDispose(disableDispose);
        bms.seek(0, SeekOrigin.Begin);
    }

    public ChunkedMemoryStream getChunkedMemoryStream() {
        return bms;
    }
